...
Yes, it uses IP addresses so it is not 100% accurate. P.S. IP addresses are [hashed and salted](https://github.com/Kryptonit3/Counter/blob/master/src/Counter.php#L93-L98) so it would be quite a daunting task to decode the data. Nice package for the pro-anonymous people :)
